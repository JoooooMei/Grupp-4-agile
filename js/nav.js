...
navToggle.addEventListener('click', () => {
    ...
    // Map `data-visible` state to `aria-expanded` true/false
    const ariaExpandedValue = newState === "open";
    navToggle.setAttribute("aria-expanded", ariaExpandedValue.toString()); // Update aria-expanded
